...
Route::get('/penyuluhan/artikel_mental/show/{id}', [PenyuluhanController::class, 'artikel_mental_show'])->name('penyuluhan.artikel_mental.show');
Route::get('/penyuluhan/artikel_kesehatan/show/{id}', [PenyuluhanController::class, 'artikel_kesehatan_show'])->name('penyuluhan.artikel_kesehatan.show');

...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            @endif
            <form method="POST" action="{{ route('penyuluhan.informasi.update',$data->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <label class="col-form-label" for="topik" style="font-weight: 500">Judul/Topik</label>
                            <input type="text" name="topik" value="{{ $data->topik }}" class="form-control" id="topik" placeholder="Masukkan judul atau deskripsi dari informasi posyandu" required>
                        </div>
                    </div>
                </div>
                <div class="row">

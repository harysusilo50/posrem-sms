@extends('layout.app')
@section('title', 'Tentang Kesehatan Remaja')
@section('content')
    <div class="card">
        <div class="card-body">
                ...
                <div class="my-auto">
                    @auth    
                        @if (Auth::user()->role == 'admin')
                            <a href="{{ route('penyuluhan.artikel_kesehatan.create') }}" class="btn btn-primary btn-sm">
                                Tambah Data
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('penyuluhan.artikel_kesehatan.show', $item->id) }}" class="btn btn-primary">Selengkapnya</a>
                            </div>
                            @auth    
                                @if (Auth::user()->role == 'admin' || Auth::user()->role == 'kader')
                                    <div class="card-footer">
                                            <a class="btn btn-success btn-sm m-1"
                                                href="{{ route('penyuluhan.artikel_kesehatan.edit', $item->id) }}">
                                            ...
                                            <div class="modal fade" id="model_delete{{ $item->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <form action="{{ route('penyuluhan.artikel_kesehatan.destroy', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
